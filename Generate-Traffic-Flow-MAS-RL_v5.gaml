...
//RL-agent
  species bus_agent skills: [advanced_driving,RSkill] { 
    ...
    action collision_detection_action{
       ...
       list cars_front_behind_1 <-  buses_1 closest_to(self, 5);
       list<bus> buses_2 <- agents_inside(bus); 
       list cars_front_behind_2 <-  buses_2 closest_to(self, 5);
	...
	action reward_calculate{
    	if(time_pass != 0){
			...
			//超速
			    ...
			    reward <-0.001 - 0.004*((Instantaneous_speed-target_speed)/target_speed); //0.006
		    }                          //0.006
