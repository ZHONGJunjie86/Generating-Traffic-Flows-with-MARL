/***
* Name: GenerateTrafficFlowMixedinput
* Author: Zjj
* Description: 
* Tags: Tag1, Tag2, TagN
***/
...
//RL-agent
  species bus_agent skills: [advanced_driving,RSkill] { 
    ...
    action Python { //D:/Software/PythonWork\GAMA_python\Generate_Traffic_Flow_MAS_RL
    	 ...
    	 do queue_set;
    	 //
    	 save [initial_point,route] to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/route.csv" type: "csv" header: false;
    	 //
    	 save cars_closest_front_1 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_front_1.csv" type: "csv" header: false;
    	 save cars_closest_front_2 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_front_2.csv" type: "csv" header: false;
    	 save cars_closest_front_3 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_front_3.csv" type: "csv" header: false;
    	 //
    	 save cars_closest_behind_1 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_behind_1.csv" type: "csv" header: false;
    	 save cars_closest_behind_2 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_behind_2.csv" type: "csv" header: false;
    	 save cars_closest_behind_3 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_behind_3.csv" type: "csv" header: false;
    	 //
    	 save cars_closest_10_1 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_1.csv" type: "csv" header: false;
    	 save cars_closest_10_2 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_2.csv" type: "csv" header: false;
    	 save cars_closest_10_3 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_NPC_3.csv" type: "csv" header: false;
    	 //
    	 save location_1 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_self_1.csv" type: "csv" header: false;
    	 save location_2 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_self_2.csv" type: "csv" header: false;
    	 save location to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_img/save_self_3.csv" type: "csv" header: false;
    	 //
    	 save state_1 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_R/GAMA_intersection_data_1.csv"  type: "csv" header: false; 
    	 save state_2 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_R/GAMA_intersection_data_2.csv"  type: "csv" header: false; 
    	 save state_3 to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_R/GAMA_intersection_data_3.csv"  type: "csv" header: false; 
         //write "read";
	     ...
	     loop while: check_receive = 0 {
	      ...
	      save [0] to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_R/python_AC_1.csv"  type: "csv" header: false; 
	      save [0] to: "D:/Software/PythonWork/GAMA_python/Generate_Traffic_Flow_MAS_RL/GAMA_R/python_AC_2.csv"  type: "csv" header: false;
	      jam<-0;
	      do queue_change;
      }    
	...
	reflex change when :current_path = nil{		
        ...
        loop while: random_node_end = random_node_start {random_node_end <- int(rnd(12));}
	...
	reflex time_to_restart when:(distance_left)<=1 or first_time = 1 or collision = 1 {  //a_flag_checked_by_light = 0 and checked = false
	     if(first_time != 1){
             done <- 1;
          	 do Python;
         ...
         save [initial_point,route] to: "D:/Software/PythonWork/GAMA_python/PPO_Mixedinput_Navigation_Model/GAMA_img/route.csv" type: "csv" header: false;
         do Python;
	} 
